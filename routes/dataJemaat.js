...
router.post('/tambahjemaat', async (req, res) => {
    try {
        const { nama, tgl_lahir, id_kota, jenis_kelamin, alamat, baptis, sidi, tgl_bergabung, id_skeluarga, id_kepala, id_pekerjaan, id_tingkatan, status_jemaat, id_pendidikan, penghasilan, id_kelompok, id_nikah, no_hp, foto, gol_darah, id_status_anggota_jemaat, suku, ket_asal_jemaat, status_data, created_by, created_at, updated_by } = req.body
        const values = [nama, tgl_lahir, id_kota, jenis_kelamin, alamat, baptis, sidi, tgl_bergabung, id_skeluarga, id_kepala, id_pekerjaan, id_tingkatan, status_jemaat, id_pendidikan, penghasilan, id_kelompok, id_nikah, no_hp, foto, gol_darah, id_status_anggota_jemaat, suku, ket_asal_jemaat, status_data, created_by, created_at,updated_by, id_kepala];
        const query = "INSERT INTO jemaat (id_jemaat, nama, tgl_lahir, id_kota, jenis_kelamin, alamat, baptis, sidi, tgl_bergabung, id_skeluarga, id_kepala, id_pekerjaan, id_tingkatan, status_jemaat, id_pendidikan, penghasilan, id_kelompok, id_nikah, no_hp, foto, no_urut_jemaat, gol_darah, id_status_anggota_jemaat, suku, ket_asal_jemaat, status_data, created_by, created_at, updated_by)"
        ...
        db.query(query, values, (error, results) => {
            ...
            const selectQuery = "SELECT id_jemaat FROM jemaat ORDER BY id_jemaat DESC LIMIT 1;";
            db.query(selectQuery, (error, selectResults) => {
                if (error) {
                    console.error(error);
                    res.status(500).json({ error: 'An error occurred while retrieving the last inserted ID' });
                    return;
                }
...
router.put('/update-jemaat/:id', (req, res) => {
    ...
    const { nama, tgl_lahir, id_kota, jenis_kelamin, alamat, baptis, sidi, tgl_bergabung, id_skeluarga, id_kepala, id_pekerjaan, id_tingkatan, id_pendidikan, penghasilan, id_kelompok, id_nikah, no_hp, foto, gol_darah, id_status_anggota_jemaat, suku, ket_asal_jemaat, updated_by,updated_at } = req.body;
    ...
    const values = [jemaatId, nama, tgl_lahir, id_kota, jenis_kelamin, alamat, baptis, sidi, tgl_bergabung, id_skeluarga, id_kepala, id_pekerjaan, id_tingkatan, id_pendidikan, penghasilan, id_kelompok, id_nikah, no_hp, foto, gol_darah, id_status_anggota_jemaat, suku, ket_asal_jemaat, updated_by, updated_at, jemaatId];
...
router.post('/updatejemaatfoto', upload.single('foto'), (req, res) => {
    try {
